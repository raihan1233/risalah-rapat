...
<div class="flex h-screen">
	<div class="w-1/5 bg-gray-800 p-4 text-white">
		...
		<ul class="mt-12">
			...
			<li class="mb-2 sm:hidden">
				<!-- Insert icon code here -->
				<svg
			...
			<!-- Text links (hidden on small screens) -->
			<li class="mb-2 hidden sm:block relative">
				<a href="/rapat" class="text-gray-300 hover:text-white block px-3 py-2 text-sm font-medium"
				   on:click={() => isOpen = !isOpen}
				>Rapat</a>
			
				<!-- Dropdown menu -->
				{#if isOpen}
				<ul class="absolute left-0 mt-2 bg-gray-800 text-white p-2 space-y-1">
					<li>
						<a href="rapat/buat-rapat" class="hover:text-gray-300">Buat Rapat</a>
					</li>
					<li>
						<a href="rapat/daftar-rapat" class="hover:text-gray-300">Daftar Rapat</a>
					</li>
				</ul>
				{/if}
			</li>
			...
			<!-- Text links (hidden on small screens) -->
			<li class="mb-2 hidden sm:block">
				<a href="/master" class="text-gray-300 hover:text-white block px-3 py-2 text-sm font-medium"
					>Master</a
				>
			</li>
			<!-- Icons (hidden on larger screens) -->
